<template>
	<view class="uni-stat__select">
		...
		<view class="uni-stat-box" :class="{'uni-stat__actived': current}">
			<view class="uni-select" :style="{height:multiple?'100%':' 34px'}"
				...
				<u-icon name="close" style="margin-right: 4px;" color="#c0c4cc" size="14" v-if="current&&current.length>0" @click="clearVal"/>
				<u-icon name="arrow-down" size="14" color="#909399" @click="toggleSelector" v-else></u-icon>
